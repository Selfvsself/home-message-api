...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, ChatRequest> textRequestConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ChatRequest> textRequestKafkaListenerContainerFactory() {
